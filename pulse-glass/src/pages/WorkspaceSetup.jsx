...
export default function WorkspaceSetup({ onJoined, onSignOut, defaultCode = '' }) {
 ...
 const card = { background: COLORS.surfaceHover, border: '1px solid rgba(255,255,255,0.15)', borderRadius: 20, padding: '44px 40px', width: 460, maxWidth: '100%', boxShadow: `0 32px 80px ${C.shadow}` }
