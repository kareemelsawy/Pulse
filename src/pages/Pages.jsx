    ...
    <div style={{ flex: 1, overflowY: 'auto', padding: 28 }}>
      <div style={{ maxWidth: 1100 }}>
        ...
        <div style={{ marginBottom: 28 }}>
          ...
          <p style={{ color: COLORS.textMuted, fontSize: 13 }}>{scopedProjects.length} program{scopedProjects.length !== 1 ? 's' : ''} · {scopedTasks.length} task{scopedTasks.length !== 1 ? 's' : ''}</p>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 340px', gap: 24, alignItems: 'start' }}>
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14 }}>
              <h2 style={{ fontWeight: 600, fontSize: 13, color: COLORS.textDim, letterSpacing: '0.04em', textTransform: 'uppercase', margin: 0 }}>Programs</h2>
