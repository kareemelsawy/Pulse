    ...
    <Shell>
      <GlassCard>
        <div style={{ marginBottom: 28 }}>
          <h2 style={{ fontSize: 22, fontWeight: 700, letterSpacing: '-0.02em', color: '#EEF2FF', margin: '0 0 6px' }}>Welcome back</h2>
        ...
        {configError && (
          <div style={{ background: 'rgba(245,158,11,0.10)', border: '1px solid rgba(245,158,11,0.22)', borderRadius: 8, padding: '10px 14px', marginBottom: 16, fontSize: 12, color: '#FCD34D', lineHeight: 1.5 }}>{configError}</div>
        )}
