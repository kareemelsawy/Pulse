...
export default function MeetingCard({ meeting, fmt, onEdit, onDelete, accentColor, showProject }) {
  ...
  return (
    <div style={{ background: 'rgba(255,255,255,0.07)', backdropFilter: 'blur(16px)', WebkitBackdropFilter: 'blur(16px)', border: '1px solid rgba(255,255,255,0.12)', borderRadius: 14, overflow: 'hidden' }}>
